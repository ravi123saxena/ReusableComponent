...
export default Home = ({ navigation, routes }) => {
  const DATA = ['CHAT CARD', 'CUSTOM BUTTON', 'IMAGE CARD', 'POST CARD', 'IMAGE CARD WITH SHADOW TITLE',
    ...
    'TEXTFIELD', 'CUSTOM TOAST', 'RADIO BUTTON GROUP', 'CUSTOM SCROLL INDICATOR', 'DATE_PICKER', 'CHARTS', 'Context', 'HOC', 
    'HOOKS', 'LOCATION MAP', 'TIME LINE']
  ...
  navigationStrings.COUNTER_HOC, navigationStrings.CUSTOM_HOOKS, navigationStrings.LOCATION_MAP, 
  navigationStrings.TIME_LINE]
