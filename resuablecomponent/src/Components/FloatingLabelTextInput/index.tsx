...
const  makeVisibleWhite =  require('../../assets/images/make_visible_white.png');

const makeInvisibleWhite = require('../../assets/images/make_invisible_white.png');

const makeVisibleBlack =  require('../../assets/images/make_visible_black.png');

const makeInvisibleBlack = require( '../../assets/images/make_invisible_black.png');
...
const FloatingLabelTextInput: React.ForwardRefRenderFunction<InputRef, Props> = (
  {
    label,
    labelProps,
    mask,
...
export default forwardRef(FloatingLabelTextInput);
